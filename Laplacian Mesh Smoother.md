...
Non-diagonal entry is $\frac{1}{2}\left(\cot(\alpha_{pq}) + \cot(\beta_{pq})\right)$, where p is the shared vertex of the 2 adjoining triangles, and q is the 2nd endpoint of the line primitive that these 2 triangles share. In the diagram I drew above, $q1$ is q. 
This will give you the weight for the red part of the diagram. We need this for all of the edges from 1 to n. So, there will be n such values. Let's call each of them $C_{pq}_i$.
...
## Coding In VEX - With Breakdown of Code
...
7. https://discourse.mcneel.com/t/cotangent-matrix/178421
8. https://ddg.math.uni-goettingen.de/pub/convergence_cotan.pdf
